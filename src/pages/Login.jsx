...
export default function Login({ onLoginSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://ebuy-backend-latest.onrender.com/api/token/', {
        method: 'POST',
      ...
      if (response.ok && data.access) {
        ...
        try {
          const profileRes = await fetch('https://ebuy-backend-latest.onrender.com/api/auth/profile/', {
